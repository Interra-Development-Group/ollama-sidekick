...
- Chat with the page you're reading, with full page context
- Mark pages as favorites — the extension crawls them on a schedule and indexes them
  into a local semantic store
- Search across everything you've saved using natural-language queries
...
Published by **Interra Development Group, LLC**.
